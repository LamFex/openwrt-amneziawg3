...
> [!IMPORTANT]
> Проект находится на стадии первого release candidate. Исходники и CI
> подготовлены, но сборка официальным SDK и испытание на реальном роутере ещё
> не выполнены. Нельзя считать пакет production-ready до прохождения
